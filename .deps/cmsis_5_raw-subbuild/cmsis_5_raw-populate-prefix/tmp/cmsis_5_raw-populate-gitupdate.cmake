...
execute_process(
  COMMAND "/usr/local/bin/git" --git-dir=.git show-ref "5.9.0"
  WORKING_DIRECTORY "/workspaces/VmaBoardRefactoring/.deps/cmsis_5_raw-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/workspaces/VmaBoardRefactoring/.deps/cmsis_5_raw-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/workspaces/VmaBoardRefactoring/.deps/cmsis_5_raw-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
