...
execute_process(
  COMMAND "/usr/local/bin/git" --git-dir=.git show-ref "v2.6.11"
  WORKING_DIRECTORY "/workspaces/VmaBoardRefactoring/.deps/cmsis_device_4_raw-src"
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("v2.6.11" tag_sha error_msg)
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(fetch_required YES)
  set(checkout_name "origin/v2.6.11")
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/workspaces/VmaBoardRefactoring/.deps/cmsis_device_4_raw-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/workspaces/VmaBoardRefactoring/.deps/cmsis_device_4_raw-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
